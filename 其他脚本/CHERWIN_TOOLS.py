...
def CHECK():
    ...
    print('>>>>>>>开始获取版本信息...')
    baseurl = 'https://gitee.com/aijiaobing/CHERWIN_SCRIPTS/raw/main/'
    TOOLS_NAME = 'CHERWIN_TOOLS.py'
    server_script_url = f'https://gitee.com/aijiaobing/CHERWIN_SCRIPTS/raw/main/{TOOLS_NAME}'
    try:
...
def main(APP_NAME, local_script_name, ENV_NAME, local_version, need_invite=False):
    ...
    git_url = f'https://gitee.com/aijiaobing/CHERWIN_SCRIPTS/raw/main/{local_script_name}'
    if CHECK():
